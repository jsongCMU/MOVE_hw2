...
% Write code here
exyz_dotdot = ...
    -Kp1*[current_state.pos-desired_state.pos]...
    -Kd1*[current_state.vel-desired_state.vel];
Fe = params.mass*(exyz_dotdot+desired_state.acc);
b3 = [0,0,1];
F = b3 * (params.mass*params.gravity+Fe);
acc = exyz_dotdot + desired_state.acc;
end
